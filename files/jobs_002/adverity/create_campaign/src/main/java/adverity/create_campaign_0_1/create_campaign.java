...
package adverity.create_campaign_0_1;
...
/**
 * Job: create_campaign Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class create_campaign implements TalendJob {
	...
	private final String jobName = "create_campaign";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					create_campaign.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(create_campaign.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_ADVERITY_create_campaign = new byte[0];
		static byte[] commonByteArray_ADVERITY_create_campaign = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADVERITY_create_campaign.length) {
					if (length < 1024
							&& commonByteArray_ADVERITY_create_campaign.length == 0) {
						commonByteArray_ADVERITY_create_campaign = new byte[1024];
					} else {
						commonByteArray_ADVERITY_create_campaign = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADVERITY_create_campaign, 0,
						length);
				strReturn = new String(
						commonByteArray_ADVERITY_create_campaign, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADVERITY_create_campaign) {
	...
	public static class row1Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.Campaign == null) ? 0 : this.Campaign
								.hashCode());
		...
		public int compareTo(row1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.Campaign, other.Campaign);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "analytics_campaign";
				} else {
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.Campaign == null) ? 0
											: this.Campaign.hashCode());
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							row2 = null;
							finder_tUniqRow_1.Campaign = row1.Campaign;
							finder_tUniqRow_1.hashCodeDirty = true;
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

								new_tUniqRow_1.Campaign = row1.Campaign;
	...
	public static void main(String[] args) {
		final create_campaign create_campaignClass = new create_campaign();

		int exitCode = create_campaignClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = create_campaign.class
					.getClassLoader().getResourceAsStream(
							"adverity/create_campaign_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : create_campaign");
		}
...
/************************************************************************************************
 * 47823 characters generated by Talend Open Studio for Data Integration on the
 * October 7, 2021 10:47:39 AM CEST
 ************************************************************************************************/
